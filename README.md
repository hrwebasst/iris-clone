...
The [fastest](https://github.com/kataras/iris#benchmarks) back-end web framework written in Go. Easy to [learn](https://docs.iris-go.com) while its highly customized.  Ideally suited for both experienced and novice Developers.
